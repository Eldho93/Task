# [Model-View-ViewModel (ie MVVM)](https://github.com/Eldho/Android-MVVM-architecture)
...
You can also check [**MVP**](https://github.com/Eldho/Android-MVP-Architecture)
